 ...
 * tabla hash indexada por EstadoJuegoTV que contiene las estimaciones de valor correspondientes.
 * 
 * @author Lorenzo Mandow
 * @version 2017-11-20
 */
public class EvaluadorTV<E extends EstadoJuegoTV<E>> extends EvaluadorEntrenable<E>{ // implements Evaluador<E> {
